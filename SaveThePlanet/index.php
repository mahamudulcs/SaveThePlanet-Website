...
<body>
    ...
    <nav>
        ...
        <ul class="menu">
            ...
            <li id="login_li_main"><a href="login/login.php">Sign in</li>
            <li id="logout_li_main"><a href="login/logout.php">Sign out</li>
            <li id="logout_li"><a href="login/register.php">Register</a></li>
        </ul>
    </nav>
    <script>
        let login_user_li_main = '<?php echo $_SESSION['login_user']; ?>';
        if (login_user_li_main && login_user_li_main != "") { 
            document.getElementById("login_li_main").style.display = "none";
            document.getElementById("logout_li_main").style.display = "";
            console.log("display 1")
        } else {
            document.getElementById("login_li_main").style.display = "";
            document.getElementById("logout_li_main").style.display = "none";
            console.log("display 2")
        }
    </script>

    <section id="main">
        <!-- <div class="home-title" style="position: absolute;">
            <h1>Save the Planet! </h1>
            <p>Explore global warming effects around the world</p>
        </div> -->
        <div class="mapdiv">
            <svg version="1.2" id="world-map" sodipodi:docname="rp.svg" viewBox="0 0 950 620">
                <g>
                    <g class="none"> 
                        <path sid="kalimantan"
                    ...
                    <a href="greenland/greenland.php" target="_blank" data-info="<div> <strong> Disappearance of Mountain <br> Glaciers </strong> <br> 
                        <img src='images/glaciers.png' alt='tree' width='40%'> <br> <br>
                        Brief info about how <br>
                        the glaciers are <br>
                        receding due to global <br>
                        warming.</div>">
                        <g id="greenland" style="fill: #9EE4D9;">
                    ...
                    <a href="westafrica/westafrica.php" target="_blank" id="mauretania" data-info="<div> <strong> Agricultural Risk </strong> <br> <br>
                        <img src='images/crops.png' alt='tree' width='30%'> <br> <br>
                        West Africa has been identified as a <br>
                        climate-change hotspot, with climate <br>
                        change likely to lessen crop yields <br>
                        and production, with resultant impathcts <br>
                        on food security.</div>">
                    <g id="westafrica" style="fill: orange;">
                        <path 
                    ...
                    <a href="australia/Australia.php" target="_blank"  data-info="<div> <strong> Heat Waves </strong> <br> 
                        <img src='images/heatwave.png' alt='tree' width='40%'> <br><br>
                        Brief info about the increase <br>
                        in temperature  due to  <br>
                        climate change caused <br>
                        by global warming </div>">
                    <g id="australia" style="fill: #FF6600;">
                            <path
                    ...
                    <a  data-info= "<div> <strong> Dying Coral Reefs </strong> <br> 
                        <img src='images/coralreefs.png' alt='tree' width='30%'> <br> <br>
                            Brief info about <br>
                            how the coral reefs <br>
                            are dying due to <br>
                            increase in ocean <br>
                            temps causes by  <br>
                            global warming. </div> " href="coralsea/coralsea.php" target="_blank">
                            <g id="coralsea" style="fill: #0CC1DA;">
                        ...
                        <a data-info= "<div> <strong> Rising Sea Levels </strong> <br> 
                            <img src='images/sealevel.png' alt='tree' width='30%'> <br> <br>
                        Brief info about rising <br>
                        sea levels along the <br>
                        cost of these countries <br>
                        in south Asia due to <br>
                        global warming </div>" href="philippines/philippines.php" target="_blank">
                        <g id="philippines" style="fill: #0a4468;">
                            <path 
                        ...
                        <a data-info= "<div> <strong> Polar Bears Extinction </strong> <br> 
                            <img src='images/polarbear.png' alt='tree' width='25%'> <br><br>
                        Brief info about <br>
                        how the polar bears <br>
                        are going extinct <br>
                        due to global warming. </div>" href="alaska/Alaska.php" target="_blank">
                            <g id="alaska" style="fill: #afa1a1;">    
                            <path 
                            d="M93.11,44.89l-8.39,1.99l1.73,9.45l9.13,2.49l0.49,1.99L82.5,65.04l-7.65,12.68l2.71,13.43L82,94.13l3.46-3.23l0.99,1.99l-4.2,4.97l-16.29,7.46l-10.37,2.49l-0.25,3.73l23.94-6.96l9.87-2.74l9.13-11.19l10.12-6.71l-5.18,8.7l5.68,0.75l9.63-4.23l1.73,6.96l6.66,1.49l6.91,6.71l0.49,4.97l-0.99,1.24l1.23,4.72h1.73l0.25-7.96h1.97l0.49,19.64l4.94-4.23l-3.46-20.39h-5.18l-5.68-7.21l27.89-47.25l-27.64-21.63l-30.85,5.97l-1.23,9.45l6.66,3.98l-2.47,6.47L93.11,44.89L93.11,44.89z" />
                        </g>
                        </a>
        
                        <a  data-info= "<div> <strong> The Amazon Wildfire </strong> <br>
                        <img src='images/tree.png' alt='tree' width='30%'> <br><br>
                        Brief info about the <br>
                        increasing wildfires <br>
                        in the amazon due to <br>
                        global warming </div>" href="brazil/brazil.php" target="_blank">
                            <g  id="brazil" style="fill: #22e262;">
                            <path
                        ...
                        <a data-info= "<div> <strong> Climatic Deasters </strong> <br> 
                            <img src='images/flood.png' alt='tree' width='30%'> <br> <br>
                            Brief info about the <br>
                            increasing Cliamtic <br>
                            desasters like floods in <br>
                            india due to climate change </div>" href="India/india.php" target="_blank">
                            <g id="india" style="fill: #dde05a;">
                                <path 
      ...
      <div class="mobile-container">
        ...
        <h1>EXPLORE GLOBAL WARMING EFFECTS AROUND THE WORLD</h1>
        </div>
        ...
        <div class="mobile-card">
            ...
            <p>
                Explore Climate Change/Global Warming Issues in Alaska. Extinction of Polar Bears.
            </p>
            <a href="alaska/Alaska.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        <div class="mobile-card">
            <div class="mobile-card-header">
            ...
            <div class="mobile-card-body">
            <p>
                Explore Climate Change/Global Warming Issues in India. Droughts and Floods.
            </p>
            <a href="India/india.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        <div class="mobile-card">
            <div class="mobile-card-header">
            ...
            <div class="mobile-card-body">
            <p>
                Explore Climate Change/Global Warming Issues in Brazil. The Amazon Wildfire.
            </p>
            <a href="brazil/brazil.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        <div class="mobile-card">
            <div class="mobile-card-header">
            ...
            <div class="mobile-card-body">
            <p>
                Explore Climate Change/Global Warming Issues in Greenland. The Melting Icecaps.
            </p>
            <a href="greenland/greenland.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        <div class="mobile-card">
            <div class="mobile-card-header">
            ...
            <div class="mobile-card-body">
            <p>
                Explore Climate Change/Global Warming Issues in Australia. The Australian Heatwave.
            </p>
            <a href="australia/Australia.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        <div class="mobile-card">
            <div class="mobile-card-header">
            ...
            <div class="mobile-card-body">
            <p>
                Explore Climate Change/Global Warming Issues in West Africa. Agricultural famin. 
            </p>
            <a href="westafrica/westafrica.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        <div class="mobile-card">
            <div class="mobile-card-header">
            ...
            <div class="mobile-card-body">
            <p>
                Explore Climate Change/Global Warming Issues in the Coral Sea. The Coral Bleaching.
            </p>
            <a href="coralsea/coralsea.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        <div class="mobile-card">
            <div class="mobile-card-header">
            ...
            <div class="mobile-card-body">
            <p>
                Explore Climate Change/Global Warming Issues in Philippines. The Rising Sea Levels.
            </p>
            <a href="philippines/philippines.php" class="mobile-btn">Read more</a>
            </div>
        </div>
        </div>
    </div>
