...
<body>
    <script type="text/javascript">
        let username = '<?php echo $_SESSION['login_user']; ?>';
        if (username != "") {
            console.log("log in");
        } else {
            console.log("not log");
    ...
    <section id="main">
        ...
        <div class="section3">
            <div class="section3-container-left">
                ...
                function post()
                {
                    ...
                    $commandText = "insert into Forum (name,comment,date) VALUES ('" . $name . "', '" . $content . "', '" . date('Y-m-d') . "')";
        ...
        <footer>
            <div class="footer">
                ...
                <script>
                    let login_user_li = '<?php echo $_SESSION['login_user']; ?>';
                    if (login_user_li && login_user_li != "") { 
